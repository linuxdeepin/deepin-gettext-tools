...
protected:
    ...
    void endVisit(AST::CallExpression *node)
    {
        if (AST::IdentifierExpression *idExpr = AST::cast<AST::IdentifierExpression *>(node->base)) {
            ...
            if (name == QLatin1String("dsTr") ||
                name == QLatin1String("D_TR_NOOP")) {
                if (!node->arguments) {
                ...
                consumeComment();
            } else if (name == QLatin1String("dsTranslate") ||
                       name == QLatin1String("D_TRANSLATE_NOOP")) {
                ...
                m_translator->extend(msg);
                consumeComment();
            } else if (name == QLatin1String("dsTrId") ||

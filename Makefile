...
install:
	...
	install -m755 desktop_ts/src/desktop_ts_convert.pl ${DESTDIR}${PREFIX}/bin/deepin-desktop-ts-convert
	install -m755 policy_ts/src/policy_ts_convert.py ${DESTDIR}${PREFIX}/bin/deepin-policy-ts-convert
